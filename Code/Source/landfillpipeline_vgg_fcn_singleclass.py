# -*- coding: utf-8 -*-
"""LandfillPipeline_VGG_FCN_SingleClass.ipynb
...
batch_size = 2
num_workers = 1
num_classes = 1       #landfill or background
epochs = 100
lr = 1e-4
w_decay = 1e-5
momentum = 0.9
...
class CustomLandfillDataset(torch.utils.data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    #print(type(rgb_image_resized), type(mask))
...
for idx in np.arange(batch_size):
  ...
  axs[count][1].imshow(mask.transpose(1,2,0).squeeze(), cmap='gray')

  axs[count][2].title.set_text(name+" with mask")
  axs[count][2].imshow(image)
  axs[count][2].imshow(mask.transpose(1,2,0).squeeze(), cmap='ocean', alpha=0.4)
  ...
  if num_classes > 1:
    ...
    axs[count][3].title.set_text('Mask Split 1')
    axs[count][3].imshow(maskHotEnc.transpose(1,2,0).squeeze(), cmap='gray')

    axs[count][4].title.set_text('Mask Split 1')
    axs[count][4].imshow(maskHotEnc.transpose(1,2,0).squeeze(), cmap='gray')
